// Official WhatsApp and Telegram brand glyphs (simple-icons paths), inlined so
// there's no icon-font or extra dependency. Color via className (currentColor).
...
export const whatsappChatHref = () =>
	`https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent("hi")}`;
export const telegramHref = () => `https://t.me/${TELEGRAM_BOT_USERNAME}`;
